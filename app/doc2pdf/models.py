...
class DocConvert(models.Model):
    ...
    convertTo = CharField(max_length=16, blank=True, null=True, db_index=True)
    outputFolder = CharField(max_length=255, blank=True, null=True, db_index=True)